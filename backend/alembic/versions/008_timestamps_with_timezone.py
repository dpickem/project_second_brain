...
TIMESTAMP_COLUMNS = {
    ...
    "mastery_questions": [("next_review_at", True), ("created_at", False)],  # next_review_at has index
    "followup_tasks": [("completed_at", False), ("created_at", False)],  # NOT followup_records!
}
...
FUNCTIONAL_INDEXES = [
    ...
    ("ix_llm_usage_logs_date_model", "llm_usage_logs", 
